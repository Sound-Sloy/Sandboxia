...
void IScreen::Draw()
{
	DrawRectangleV(m_Properties.Pos, m_Properties.Size, Color(255, 255, 255, 150));
	DrawTextEx(GetFontDefault(), std::string(m_Name + std::to_string(GetFPS())).c_str(), m_Properties.Pos, 24.f, 0.f, Color(0, 0, 0, 255));
}
